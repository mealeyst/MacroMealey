...
const config = {
  ...
  styles: {
    ...
    toolkit: {
      src: '../static/assets/css/build/main.scss',
      dest: '../static/assets/css/build',
      watch: '../static-src/assets/src-scss/**/*.scss',
    },
  },
  scripts: {
    fabricator: {
    ...
    toolkit: {
      src: '../static/assets/js/bundle.js',
      dest: '../static/assets/js',
      watch: '../static-src/assets/src-js/**/*',
    },
  },
  images: {
    toolkit: {
