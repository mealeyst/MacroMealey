...
const config = {
  ...
  styles: {
    ...
    fabricator: {
      ...
      dest: 'static/styleguide/assets/fabricator/styles',
      watch: 'src/assets/fabricator/styles/**/*.scss',
    },
    toolkit: {
      src: 'src/assets/toolkit/styles/toolkit.scss',
      dest: 'static/styleguide/assets/toolkit/styles',
  ...
  scripts: {
    fabricator: {
      ...
      dest: 'static/styleguide/assets/fabricator/scripts',
      watch: 'src/assets/fabricator/scripts/**/*',
    },
    toolkit: {
      src: './src/assets/toolkit/scripts/toolkit.js',
      dest: 'static/styleguide/assets/toolkit/scripts',
  ...
  images: {
    toolkit: {
      ...
      dest: 'static/styleguide/assets/toolkit/images',
  ...
  fonts: {
    toolkit: {
      ...
      dest: 'static/styleguide/assets/toolkit/fonts'
    }
  },
  templates: {
    watch: 'src/**/*.{html,md,json,yml}',
  },
  dest: 'static/styleguide',
};
